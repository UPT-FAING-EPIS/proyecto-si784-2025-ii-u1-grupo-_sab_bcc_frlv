...
def test_ml_detection():
    ...
    print("[ML] PRUEBA DE DETECCIÓN ML")
    print("=" * 50)
    ...
    if not detector.is_loaded():
        print("[ERROR] Error: Detector ML no está cargado")
        return False
    
    print("[OK] Detector ML inicializado")
    ...
    try:
        ...
        print(f"   [ERROR] Error en batch: {e}")
    ...
    print("\n[OK] PRUEBA DE DETECCIÓN ML COMPLETADA")
    return True

def test_network_analysis():
    """Prueba el análisis de datos de red"""
    print("\n[NET] PRUEBA DE ANÁLISIS DE RED")
    print("=" * 50)
    ...
    try:
        ...
        print(f"[ERROR] Error en análisis de red: {e}")
        return False

def main():
    """Función principal de pruebas"""
    print("[TEST] SUITE DE PRUEBAS ML AVANZADAS")
    print("=" * 60)
